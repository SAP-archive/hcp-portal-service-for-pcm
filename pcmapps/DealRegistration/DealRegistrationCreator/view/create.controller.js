(function() {
	...
	sap.ui.controller("c4c.create-DealRegistrationCollection.remote.view.create", {
		...
		valueHelpersMetaData: {
			...
			"CampaignID_614": {
				...
				"comboBox": false,
				"BusinessObject": "DealRegistrationCollection",
				"prefixKey": "CHP.DealRegistration.CampaignID.Common.ValueList",
				"titleKey": "CHP.DealRegistration.UI.Identification.UI.DataField.CampaignID",
		...
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.create-DealRegistrationCollection.remote.view.vhelpdialog");
