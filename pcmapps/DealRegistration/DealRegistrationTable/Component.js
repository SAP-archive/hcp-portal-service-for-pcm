sap.ui.define(["sap/ui/core/UIComponent", "sap/ui/model/odata/ODataUtils"], function(UIComponent) {
	return UIComponent.extend("c4c.table-dealregistrationcollection.local.Component", {
		...
		configuration: {
			componentName: "/DealRegistration/DealRegistrationTable",
			applicationPath: "/pcmapps",
			fioriPrefix: "/sap/fiori",
			appServiceSuffix: "/sap/c4c/odata/v1/pcmportal",
			businessObject: {
				targetEntity: "DealRegistrationCollection",
				semanticObject: "DealRegistration",
				growingThreshold: 15,
				queries: [{
						name: "CHP.DealRegistration.UI.Query.UI.Filter.AllDeals",
						type: "Parameter",
						isDefault: "true",
						filter: []
					}
		...
		setModulePath: function() {
			...
			try {
				if (sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.table-dealregistrationcollection.local", this.configuration.appName);
					jQuery.sap.registerModulePath("c4c.table-dealregistrationcollection.remote", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var appEventsBus = new sap.ui.core.EventBus(),
				dialogView = sap.ui.view({
					viewName: "c4c.table-dealregistrationcollection.local.view.dialog",
				...
				view = sap.ui.view({
					viewName: "c4c.table-dealregistrationcollection.local.view.table",
					type: sap.ui.core.mvc.ViewType.XML,
					viewData: {
