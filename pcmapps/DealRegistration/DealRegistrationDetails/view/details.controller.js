(function() {
	...
	sap.ui.controller("c4c.details-dealregistrationcollection.local.view.details", {

		valueHelpersMetaData: {
			"DealRegistration": {
				"combobox": {
					"TotalValueCurrencyCode": {
						"CollectionPath": "DealRegistrationTotalValueCurrencyCode",
						...
						"filterable": [],
						"comboBox": true,
						"BusinessObject": "DealRegistrationCollection",
						"enabled": true
					},
					"UserStatusCode": {
						"CollectionPath": "DealRegistrationUserStatusCode",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"UserStatusCode"
					...
					"Country": {
						"CollectionPath": "DealRegistrationCountry",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"Country"
			...
			"DealItem": {
				"ProductID": {
					...
					"comboBox": false,
					"BusinessObject": "DealItemCollection",
					"prefixKey": "CHP.DealItem.ProductID.Common.ValueList",
					"titleKey": "CHP.DealItem.UI.LineItem.UI.DataField.ProductID",
					"fieldName": "ProductID"
				},
				"combobox": {
					"QuantityUnitOfMeasure": {
						"CollectionPath": "DealItemQuantityUnitOfMeasure",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"QuantityUnitOfMeasure"
			...
			"Questionnaire1": {
				"combobox": {
					"Answer": {
						"CollectionPath": "Questionnaire1Answer",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"Answer"
						...
						"filterable": [],
						"comboBox": true,
						"BusinessObject": "Questionnaire1Collection",
						"enabled": true
					}
				}
			},
		...
		updateFields: ["ObjectID", "AccountID", "City", "Company", "ContactLastName", "Country", "DealName", "EndDate", "EngagementType",
			"PartyID", "PostalCode", "StartDate", "State", "TotalValue", "TotalValueCurrencyCode", "UserStatusCode"
		],
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.details-dealregistrationcollection.local.view.vhelpdialog");
		...
		loadData: function(collectionId) {
			...
			oDataServiceModel.attachMetadataLoaded({}, function() {
				...
				this.readSubObject(oDataServiceModel, collectionApi, "DealItem", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "Questionnaire1", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "Questionnaire2", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "DealDocumentFlow", oJsonModel, counter);
		...
		openActions: function openActions(oEvent) {
			...
			if (!this.actionSheet) {
				this.actionSheet = sap.ui.xmlfragment(
					"c4c.details-dealregistrationcollection.local.view.actions.actionsSheet",
					this
				);
		...
		handleOpenDialog: function(oEvent) {
			this.oDialog = sap.ui.xmlfragment("c4c.details-dealregistrationcollection.local.view.dialog.delete", this);
		...
		showAddDialog: function showAddDialog() {
			...
			var fragmentName = "c4c.details-dealregistrationcollection.local.view.dialog." + this.tableName + "Add";
		...
		onEditFacetItem: function onEditFacetItem(oEvent) {
			...
			var fragmentName = "c4c.details-dealregistrationcollection.local.view.dialog." + this.tableName + "Update";
			this.oDialog = sap.ui.xmlfragment(fragmentName, this);
			this.getView().addDependent(this.oDialog);
		...
		getFormFragment: function(sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(
				this.getView().getId(),
				"c4c.details-dealregistrationcollection.local.view.details" + sFragmentName,
				this
			);
		...
		getFormView: function getFormView() {
			return this.getView().byId("DealRegistrationCollection_Form");
		},
