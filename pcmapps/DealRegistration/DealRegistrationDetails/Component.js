sap.ui.define(["sap/ui/core/UIComponent"], function(UIComponent) {
	return UIComponent.extend("c4c.details-dealregistrationcollection.local.Component", {
		metadata: {
			manifest: "json"
		},

		configuration: {
			componentName: "/DealRegistration/DealRegistrationDetails",
		...
		setModulePath: function() {
			...
			try {
				if (sap.ushell && sap.ushell.services && sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.details-dealregistrationcollection.local", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var view = sap.ui.view({
				viewName: "c4c.details-dealregistrationcollection.local.view.details",
