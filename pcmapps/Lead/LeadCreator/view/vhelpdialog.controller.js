(function() {
	...
	sap.ui.controller("c4c.create-LeadCollection.remote.view.vhelpdialog", {
		...
		onInit: function(data) {
			...
			this.oDialog = sap.ui.jsfragment("c4c.create-LeadCollection.remote.view.vhelpdialog", this);
