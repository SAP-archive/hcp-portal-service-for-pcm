(function() {
	...
	sap.ui.controller("c4c.create-LeadCollection.remote.view.create", {
		...
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.create-LeadCollection.remote.view.vhelpdialog");
