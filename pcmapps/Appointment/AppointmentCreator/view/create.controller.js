(function() {
	...
	sap.ui.controller("c4c.create-AppointmentCollection.remote.view.create", {
		...
		valueHelpersMetaData: {
			"AccountID_545": {
				...
				"prefixKey": "CHP.Appointment.AccountID.Common.ValueList",
				"titleKey": "CHP.Appointment.UI.Identification.UI.DataField.AccountID",
				"fieldName": "AccountID"
			},
			"combobox": {
				"Category": {
		...
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.create-AppointmentCollection.remote.view.vhelpdialog");
