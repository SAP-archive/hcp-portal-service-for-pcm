(function() {
	...
	sap.ui.controller("c4c.details-partnercollection.local.view.vhelpdialog", {
		...
		onInit: function(data) {
			...
			this.oDialog = sap.ui.jsfragment("c4c.details-partnercollection.local.view.vhelpdialog", this);
