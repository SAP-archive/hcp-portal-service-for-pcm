(function() {
	...
	sap.ui.controller("c4c.details-partnercollection.local.view.details", {
			...
			"Partner": {
				"combobox": {
					"Level": {
						...
						"filterable": [],
						"comboBox": true,
						"BusinessObject": "PartnerCollection",
						"enabled": true
					}
				}
			},
		...
		updateFields: ["ObjectID", "ABCClassification", "AdditionalName", "CategoryCode", "DUNS", "Level", "LifeCycleStatusCode", "Name",
			"PartnerID"
		],
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.details-partnercollection.local.view.vhelpdialog");
		...
		loadData: function(collectionId) {
			...
			var viewData = {
				"Partner": {
					"Name": null,
					"AdditionalName": null,
					"LifeCycleStatusCodeText": null,
					"ABCClassification": null,
					"Level": null,
					"IndustryCodeText": null,
					"DUNS": null
				},
				"PartnerAddress": {},
				"PartnerProgram": {
			...
			oDataServiceModel.attachMetadataLoaded({}, function() {
				...
				this.readSubObject(oDataServiceModel, collectionApi, "PartnerAddress", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "PartnerProgram", oJsonModel, counter);
		...
		openActions: function openActions(oEvent) {
			...
			if (!this.actionSheet) {
				this.actionSheet = sap.ui.xmlfragment(
					"c4c.details-partnercollection.local.view.actions.actionsSheet",
					this
				);
		...
		handleOpenDialog: function(oEvent) {
			this.oDialog = sap.ui.xmlfragment("c4c.details-partnercollection.local.view.dialog.delete", this);
		...
		showAddDialog: function showAddDialog() {
			...
			var fragmentName = "c4c.details-partnercollection.local.view.dialog." + this.tableName + "Add";
		...
		onEditFacetItem: function onEditFacetItem(oEvent) {
			...
			var fragmentName = "c4c.details-partnercollection.local.view.dialog." + this.tableName + "Update";
			this.oDialog = sap.ui.xmlfragment(fragmentName, this);
			this.getView().addDependent(this.oDialog);
		...
		getFormFragment: function(sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(
				this.getView().getId(),
				"c4c.details-partnercollection.local.view.details" + sFragmentName,
				this
			);
		...
		getFormView: function getFormView() {
			return this.getView().byId("PartnerCollection_Form");
		},
