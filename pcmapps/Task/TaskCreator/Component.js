sap.ui.define(["sap/ui/core/UIComponent"], function(UIComponent) {
	return UIComponent.extend("c4c.create-TaskCollection.local.Component", {
		metadata: {
			manifest: "json"
		},

		configuration: {
			componentName: "/Task/TaskCreator",
		...
		setConfiguration: function() {
			...
			try {
				if (sap.ushell && sap.ushell.services && sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.create-TaskCollection.local", this.configuration.appName);
					jQuery.sap.registerModulePath("c4c.create-TaskCollection.remote", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var view = sap.ui.view({
				viewName: "c4c.create-TaskCollection.local.view.create",
