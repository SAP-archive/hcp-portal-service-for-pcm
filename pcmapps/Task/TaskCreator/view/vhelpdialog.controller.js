(function() {
	...
	sap.ui.controller("c4c.create-TaskCollection.remote.view.vhelpdialog", {
		...
		onInit: function(data) {
			...
			this.oDialog = sap.ui.jsfragment("c4c.create-TaskCollection.remote.view.vhelpdialog", this);
