(function() {
	...
	sap.ui.controller("c4c.create-AccountCollection.remote.view.vhelpdialog", {
		...
		onInit: function(data) {
			...
			this.oDialog = sap.ui.jsfragment("c4c.create-AccountCollection.remote.view.vhelpdialog", this);
