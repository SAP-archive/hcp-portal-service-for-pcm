sap.ui.define(["sap/ui/core/UIComponent"], function(UIComponent) {
	return UIComponent.extend("c4c.create-AccountCollection.local.Component", {
		metadata: {
			manifest: "json"
		},

		configuration: {
			componentName: "/Account/AccountCreator",
		...
		setConfiguration: function() {
			...
			try {
				if (sap.ushell && sap.ushell.services && sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.create-AccountCollection.local", this.configuration.appName);
					jQuery.sap.registerModulePath("c4c.create-AccountCollection.remote", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var view = sap.ui.view({
				viewName: "c4c.create-AccountCollection.local.view.create",
