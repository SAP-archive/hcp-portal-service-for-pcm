sap.ui.define(["sap/ui/core/UIComponent", "sap/ui/model/odata/ODataUtils"], function(UIComponent) {
	return UIComponent.extend("c4c.table-accountcollection.local.Component", {
		...
		setModulePath: function() {
			...
			try {
				if (sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.table-accountcollection.local", this.configuration.appName);
					jQuery.sap.registerModulePath("c4c.table-accountcollection.remote", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var appEventsBus = new sap.ui.core.EventBus(),
				dialogView = sap.ui.view({
					viewName: "c4c.table-accountcollection.local.view.dialog",
				...
				view = sap.ui.view({
					viewName: "c4c.table-accountcollection.local.view.table",
					type: sap.ui.core.mvc.ViewType.XML,
					viewData: {
