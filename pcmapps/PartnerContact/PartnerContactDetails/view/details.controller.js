(function() {
	...
	sap.ui.controller("c4c.details-partnercontactcollection.local.view.details", {

		valueHelpersMetaData: {
			"PartnerContact": {}
		},

		updateFields: ["ObjectID", "AcademicTitle", "RoleCode", "Status"],
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.details-partnercontactcollection.local.view.vhelpdialog");
		...
		openActions: function openActions(oEvent) {
			...
			if (!this.actionSheet) {
				this.actionSheet = sap.ui.xmlfragment(
					"c4c.details-partnercontactcollection.local.view.actions.actionsSheet",
					this
				);
		...
		handleOpenDialog: function(oEvent) {
			this.oDialog = sap.ui.xmlfragment("c4c.details-partnercontactcollection.local.view.dialog.delete", this);
		...
		showAddDialog: function showAddDialog() {
			...
			var fragmentName = "c4c.details-partnercontactcollection.local.view.dialog." + this.tableName + "Add";
		...
		onEditFacetItem: function onEditFacetItem(oEvent) {
			...
			var fragmentName = "c4c.details-partnercontactcollection.local.view.dialog." + this.tableName + "Update";
			this.oDialog = sap.ui.xmlfragment(fragmentName, this);
			this.getView().addDependent(this.oDialog);
		...
		getFormFragment: function(sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(
				this.getView().getId(),
				"c4c.details-partnercontactcollection.local.view.details" + sFragmentName,
				this
			);
		...
		getFormView: function getFormView() {
			return this.getView().byId("PartnerContactCollection_Form");
		},
