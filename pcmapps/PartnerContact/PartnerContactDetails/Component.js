sap.ui.define(["sap/ui/core/UIComponent"], function(UIComponent) {
	return UIComponent.extend("c4c.details-partnercontactcollection.local.Component", {
		metadata: {
			manifest: "json"
		},

		configuration: {
			componentName: "/PartnerContact/PartnerContactDetails",
		...
		setModulePath: function() {
			...
			try {
				if (sap.ushell && sap.ushell.services && sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.details-partnercontactcollection.local", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var view = sap.ui.view({
				viewName: "c4c.details-partnercontactcollection.local.view.details",
