(function() {
	...
	sap.ui.controller("c4c.create-PartnerContactCollection.remote.view.vhelpdialog", {
		...
		onInit: function(data) {
			...
			this.oDialog = sap.ui.jsfragment("c4c.create-PartnerContactCollection.remote.view.vhelpdialog", this);
