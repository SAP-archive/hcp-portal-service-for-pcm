(function() {
	...
	sap.ui.controller("c4c.details-opportunitycollection.local.view.details", {

		valueHelpersMetaData: {
			"Opportunity": {
				"combobox": {
					"Category": {
						"CollectionPath": "OpportunityCategory",
						...
						"filterable": [],
						"comboBox": true,
						"BusinessObject": "OpportunityCollection",
						"enabled": true
					},
					"ExpectedValueCurrencyCode": {
						"CollectionPath": "OpportunityExpectedValueCurrencyCode",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"ExpectedValueCurrencyCode"
					...
					"SalesPhase": {
						"CollectionPath": "OpportunitySalesPhase",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"SalesPhase"
					...
					"SalesCycle": {
						"CollectionPath": "OpportunitySalesCycle",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"SalesCycle"
			...
			"OpportunityItem": {
				"ProductID": {
					...
					"comboBox": false,
					"BusinessObject": "OpportunityItemCollection",
					"prefixKey": "CHP.OpportunityItem.ProductID.Common.ValueList",
					"titleKey": "CHP.OpportunityItem.UI.LineItem.UI.DataField.ProductID",
					"fieldName": "ProductID"
				},
				"combobox": {
					"QuantityUnitOfMeasure": {
						"CollectionPath": "OpportunityItemQuantityUnitOfMeasure",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"QuantityUnitOfMeasure"
			...
			"OpportunityContact": {},
			"OpportunityInvolvedParty": {},
			"OpportunityAttachment": {
				"combobox": {
					"CategoryCode": {
						"CollectionPath": "OpportunityAttachmentCategoryCode",
						"searchSupported": false,
						"viewParams": {
							"Code": [
								"CategoryCode"
						...
						"filterable": [],
						"comboBox": true,
						"BusinessObject": "OpportunityAttachmentCollection",
						"enabled": true
					}
				}
			}
		...
		updateFields: ["ObjectID", "Category", "CloseDate", "ExpectedValue", "ExpectedValueCurrencyCode", "OpportunityName", "OwnerName",
			"Priority", "Probability", "SalesPhase", "StartDate", "StatusCode"
		],
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.details-opportunitycollection.local.view.vhelpdialog");
		...
		loadData: function(collectionId) {
			...
			var viewData = {
				"Opportunity": {
					...
					"CloseDate": null,
					"ExpectedValue": null,
					"ExpectedValueCurrencyCode": null,
					"SalesPhase": null,
					"SalesCycle": null,
					"StatusText": null,
					"OwnerName": null
			...
			oDataServiceModel.attachMetadataLoaded({}, function() {
				...
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunityItem", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunityCompetitor", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunitySalesTeam", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunityContact", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunityInvolvedParty", oJsonModel, counter);
				this.readSubObject(oDataServiceModel, collectionApi, "OpportunityAttachment", oJsonModel, counter);
		...
		openActions: function openActions(oEvent) {
			...
			if (!this.actionSheet) {
				this.actionSheet = sap.ui.xmlfragment(
					"c4c.details-opportunitycollection.local.view.actions.actionsSheet",
					this
				);
		...
		handleOpenDialog: function(oEvent) {
			this.oDialog = sap.ui.xmlfragment("c4c.details-opportunitycollection.local.view.dialog.delete", this);
		...
		showAddDialog: function showAddDialog() {
			...
			var fragmentName = "c4c.details-opportunitycollection.local.view.dialog." + this.tableName + "Add";
		...
		onEditFacetItem: function onEditFacetItem(oEvent) {
			...
			var fragmentName = "c4c.details-opportunitycollection.local.view.dialog." + this.tableName + "Update";
			this.oDialog = sap.ui.xmlfragment(fragmentName, this);
			this.getView().addDependent(this.oDialog);
		...
		getFormFragment: function(sFragmentName) {
			...
			oFormFragment = sap.ui.xmlfragment(
				this.getView().getId(),
				"c4c.details-opportunitycollection.local.view.details" + sFragmentName,
				this
			);
		...
		getFormView: function getFormView() {
			return this.getView().byId("OpportunityCollection_Form");
		},
