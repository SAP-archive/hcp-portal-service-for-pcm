(function() {
	...
	sap.ui.controller("c4c.create-OpportunityCollection.remote.view.create", {
		...
		valueHelpersMetaData: {
			"AccountID_369": {
				...
				"prefixKey": "CHP.Opportunity.AccountID.Common.ValueList",
				"titleKey": "CHP.Opportunity.UI.Identification.UI.DataField.AccountID",
				"fieldName": "AccountID"
			},
			"combobox": {
				"Category": {
				...
				"ExpectedValueCurrencyCode": {
					...
					"comboBox": true,
					"BusinessObject": "OpportunityCollection",
					"id": "ExpectedValueCurrencyCode_375"
				},
				"SalesPhase": {
		...
		openValueHelpDialog: function openValueHelpDialog(oController) {
			...
			var oValueHelpDialog = sap.ui.controller("c4c.create-OpportunityCollection.remote.view.vhelpdialog");
