sap.ui.define(["sap/ui/core/UIComponent", "sap/ui/model/odata/ODataUtils"], function(UIComponent) {
	return UIComponent.extend("c4c.table-opportunitycollection.local.Component", {
		...
		configuration: {
			componentName: "/Opportunity/OpportunityTable",
			applicationPath: "/pcmapps",
			fioriPrefix: "/sap/fiori",
			appServiceSuffix: "/sap/c4c/odata/v1/pcmportal",
			businessObject: {
				targetEntity: "OpportunityCollection",
				semanticObject: "Opportunity",
				growingThreshold: 15,
				queries: [{
					name: "CHP.Opportunity.UI.Query.UI.Filter.AllOpportunities",
					type: "Parameter",
					isDefault: "true",
					filter: []
				}, {
					name: "CHP.Opportunity.UI.Query.UI.Filter.MyOpportunities",
					funcName: "Get_My_Opportunities",
					type: "FunctionImport",
					isDefault: "false",
					filter: []
				}]
		...
		setModulePath: function() {
			...
			try {
				if (sap.ushell.services.AppConfiguration) {
					...
					jQuery.sap.registerModulePath("c4c.table-opportunitycollection.local", this.configuration.appName);
					jQuery.sap.registerModulePath("c4c.table-opportunitycollection.remote", this.configuration.appName);
				} else {
		...
		createContent: function() {
			...
			var appEventsBus = new sap.ui.core.EventBus(),
				dialogView = sap.ui.view({
					viewName: "c4c.table-opportunitycollection.local.view.dialog",
				...
				view = sap.ui.view({
					viewName: "c4c.table-opportunitycollection.local.view.table",
					type: sap.ui.core.mvc.ViewType.XML,
					viewData: {
